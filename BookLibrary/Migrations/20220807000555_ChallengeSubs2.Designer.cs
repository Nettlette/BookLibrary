...
namespace BookLibrary.Migrations
{
    ...
    [Migration("20220807000555_ChallengeSubs2")]
    partial class ChallengeSubs2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookLibrary.Models.BooksPublished", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookLibrary.Models.ChallengeElement", b =>
                {
                    b.Property<int>("ChallengeElementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChallengeElementId"), 1L, 1);
            ...
            modelBuilder.Entity("BookLibrary.Models.ChallengeSubscription", b =>
                {
                    b.Property<int>("ChallengeSubscriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChallengeSubscriptionId"), 1L, 1);
                    ...
                    b.HasKey("ChallengeSubscriptionId");

                    b.HasIndex("ChallengeId");

                    b.HasIndex("ReaderId");

                    b.ToTable("ChallengeSubscription");
                });

            modelBuilder.Entity("BookLibrary.Models.ElementCompleted", b =>
                {
                    b.Property<int>("ElementCompletedId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ElementCompletedId"), 1L, 1);
                    ...
                    b.HasKey("ElementCompletedId");

                    b.HasIndex("BooksReadId");

                    b.HasIndex("ChallengeElementId");
            ...
            modelBuilder.Entity("BookLibrary.Models.LocationChartView", b =>
                {
                    b.Property<int>("CountRead")
                        .HasColumnType("int");
                    ...
                    b.ToView("LocationChartView");
                });

            modelBuilder.Entity("BookLibrary.Models.LocationIndex", b =>
                {
                    ...
                    b.ToView("LocationIndex");
                });

            modelBuilder.Entity("BookLibrary.Models.PagesHoursByAuthorView", b =>
                {
                    b.Property<int>("AuthorId")
                        .HasColumnType("int");
                    ...
                    b.ToView("PagesHoursByAuthorView");
                });
            ...
            modelBuilder.Entity("BookLibrary.Models.SubcategoryChartView", b =>
                {
                    b.Property<int>("CountRead")
                        .HasColumnType("int");
                    ...
                    b.ToView("SubcategoryChartView");
                });

            modelBuilder.Entity("BookLibrary.Models.TopAuthors", b =>
                {
                    b.Property<int>("AuthorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookLibrary.Models.ChallengeElement", b =>
                {
                    b.HasOne("BookLibrary.Models.Challenge", "Challenge")
                        .WithMany()
            ...
            modelBuilder.Entity("BookLibrary.Models.ElementCompleted", b =>
                {
                    b.HasOne("BookLibrary.Models.BooksRead", "BooksRead")
                        .WithMany()
                        .HasForeignKey("BooksReadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookLibrary.Models.ChallengeElement", "ChallengeElement")
                        .WithMany()
                        .HasForeignKey("ChallengeElementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
